...
const { defineConfig } = require('eslint/config');
const uphold = require('eslint-config-uphold');
const mocha = require('eslint-config-uphold/configs/mocha');
...
Those can be imported from `eslint-config-uphold/configs`, or directly:

```js
const { jest, mocha, vitest } = require('eslint-config-uphold/configs');
const jest = require('eslint-config-uphold/configs/jest');
const mocha = require('eslint-config-uphold/configs/mocha');
const vitest = require('eslint-config-uphold/configs/vitest');
```
