...
const jsdocPluginRules = {
  'jsdoc/no-defaults': 0,
  'jsdoc/require-description-complete-sentence': ['error', { abbreviations: ['e.g.', 'i.e.', 'etc.'] }],
 ...
 * @type {LinterConfig}
 */
export const upholdPluginConfig = isSinonAvailable
  ? {
